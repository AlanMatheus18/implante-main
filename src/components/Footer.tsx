        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              ...
              há mais de 13 anos com tecnologia de ponta e atendimento humanizado.
            </p>
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/dentalsanteodontologia" className="text-gray-400 hover:text-purple-400 transition-colors" aria-label="Facebook" target='blank' rel='noopener noreferrer'>
                <Facebook className="h-6 w-6" />
              </a>
              <a href="https://www.instagram.com/dental_sante/" target='blank' className="text-gray-400 hover:text-purple-400 transition-colors" aria-label="Instagram">
                <Instagram className="h-6 w-6" />
              </a>
              <a href="https://www.youtube.com/channel/UCUAu_NRfULhAiXmlP86Dq6A" target='blank' className="text-gray-400 hover:text-purple-400 transition-colors" aria-label="YouTube">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <div>
                  <a href="tel:+558193094-0025" className="hover:text-purple-400 transition-colors">
                    (81) 3094-0025
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <a href="mailto:contato@dentalsante.com.br" className="hover:text-purple-400 transition-colors">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} Clínica Odontológica Dental Santé. Todos os direitos reservados.
            </p>
